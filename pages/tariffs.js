              ...
              <div className={`tariffs-items-content d-grid`}>
                <div className={`tariff-item`}>
                  ...
                  <div className={`tariff-item-content`}>
                    <div
                      className={`tariff-item-trigger d-flex align-items-center`}
                    >
                      <div className={`tariff-item-trigger-icon`}>
                        <img src="../images/tariff-check.svg" alt="" />
                      </div>
                      <div className={`tariff-item-trigger-text`}>
                  ...
                  <div className={`tariff-item-bottom`}>
                    <button
                      className={`btn btn_tariff-buy w-100 h-100`}
                      disabled
                    >
                      Купить тариф
                    </button>
                ...
                <div className={`tariff-item`}>
                  ...
                  <div className={`tariff-item-bottom`}>
                    <button className={`btn btn_tariff-buy w-100 h-100`}>
                      Купить тариф
                    </button>
                  </div>
                </div>
